        ...
        <div className="mt-8">
          ...
          <div className="flex justify-between mt-3">
            <button
              ...
              className="px-4 py-1 bg-yellow-500 text-white text-xs rounded hover:bg-yellow-600"
            >
              Edit
            </button>
            <button
              onClick={() => onDeleteClick(driver.id)}
              className="px-4 py-1 bg-red-500 text-white text-xs rounded hover:bg-red-600"
            >
              Delete
            </button>
          </div>
