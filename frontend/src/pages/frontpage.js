...
const Frontpage = () => {
  ...
  return (
    ...
    >
      <Navbar />
      <section className="flex flex-col items-center justify-center h-full bg-gray-900 bg-opacity-75">
        <h1 className="text-center text-2xl md:text-4xl lg:text-5xl text-white font-bold mb-4">
          Welcome to the F1 Special Event
        </h1>
